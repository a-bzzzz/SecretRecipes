"""
Django settings for secret_recipes project.
...
SECRET_KEY = "django-insecure-dpku*po@4r(rl-8pz!pu%bx)lg=yqal1qeo)=h!(vfi!a&d2%@"
...
ROOT_URLCONF = "secret_recipes.urls"
...
WSGI_APPLICATION = "secret_recipes.wsgi.application"
